...
window.addEventListener('DOMContentLoaded', function () {
  ...
  difference.init();
  var form = new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]('.form', 'assets/question.php');
  form.init();
  ...
  _createClass(Difference, [{
    ...
    value: function hideItems(items) {
      items.forEach(function (item, i, arr) {
        if (i !== arr.length - 1) {
          //Скрываем все карточки кроме последнегоо
...
function () {
  ...
  _createClass(Download, [{
    key: "downoladItem",
    value: function downoladItem(path) {
...
/* harmony import */ var _mask__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mask */ "./src/js/modules/mask.js");
...
function () {
  ...
  _createClass(Forms, [{
    ...
    value: function checkTextInputs(selector) {
      var emailInputs = document.querySelectorAll(selector);
    ...
    value: function init() {
      ...
      this.form.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          _this.postData(_this.api, formData).then(function (res) {
      ...
      this.btns.forEach(function (btn) {
        if (!btn.closest('.module__info-controls')) {
          btn.addEventListener('click', function () {
            ...
            _this2.slides[_this2.slideIndex - 1].classList.add('fadeIn');
          });
        }
        ...
        btn.parentNode.previousElementSibling.addEventListener('click', function (e) {
          ...
          _this2.showSlides(_this2.slideIndex); // this.slides[this.slideIndex - 1].classList.add('fadeIn');
